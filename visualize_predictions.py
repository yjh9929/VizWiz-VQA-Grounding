...
model.load_state_dict(torch.load("outputs/model_final_epoch10.pt", map_location=device))
model.eval()
...
# 저장
os.makedirs("result/model_final_epoch10", exist_ok=True)
save_path = "result/model_final_epoch10/VizWiz_test_00000006_masked.png" # 이거 바꿔가면서 실험해봐요
