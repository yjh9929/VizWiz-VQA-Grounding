...
model.load_state_dict(torch.load("outputs/clip-vit-large-patch14.pt", map_location=device))
model.eval()
...
# 저장
os.makedirs("result/clip-vit-large-patch14", exist_ok=True)
save_path = "result/clip-vit-large-patch14/VizWiz_test_00000006_masked.png" # 이거 바꿔가면서 실험해봐요
